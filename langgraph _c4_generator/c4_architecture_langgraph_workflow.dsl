workspace {
    model {
        ...
        user_interface = component "User Interface" "The interface where users enter their questions and interact with the system."
        parser = component "Parser" "Processes the user input and extracts relevant information for further processing."
        summarizer = component "Summarizer" "Summarizes the parsed information to create a concise representation."
